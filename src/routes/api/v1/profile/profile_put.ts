 ...
 *   put:
 *     tags: [Profile]
 *     summary: Actualizar perfil del usuario autenticado (PUT)
 *     description: |
 *       Actualiza campos del perfil: name, lastname, username, phone.
 *       Para el avatar, envía multipart/form-data con el campo `avatar`.
 ...
 */
putProfileRouter.put('/', requireAuth, upload.single('avatar'), async (req: Request, res: Response) => {
  try {
    const file = req.file
